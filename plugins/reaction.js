    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            if (mentionedUser) {
                ...
                message = `> © Powᴇʀᴇᴅ Bʏ ᴍᴀᴄᴏᴅᴇʀ xMᴅ`;
            }
    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            if (mentionedUser) {
                ...
                message = `> © Powᴇʀᴇᴅ ʙʏ ᴍᴀᴄᴏᴅᴇʀ xMᴅ`;
            }
