...
cmd({
  ...
  reply("> ᴍᴀᴄᴏᴅᴇʀ xᴍᴅ🫅ɪs ғᴇᴛᴄʜɪɴɢ ᴀᴜᴅɪᴏ... 🎧");
  ...
  if (!spotifySent && !youtubeSent) {
    ...
    reply("ᴍᴀᴄᴏᴅᴇʀ xᴍᴅ🫅: sᴘᴏᴛɪғʏ ᴀᴜᴅɪᴏ sᴇɴᴛ sᴜᴄᴄᴇsғᴜʟʟʏ.");
  } else if (youtubeSent) {
    reply("ᴍᴀᴄᴏᴅᴇʀ ᴄᴍᴅ: ʏᴏᴜᴛᴜʙᴇ ᴀᴜᴅɪᴏ sᴇɴᴛ sᴜᴄᴄᴇsғᴜʟʟʏ.");
  }
});
