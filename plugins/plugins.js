...
const REPO_OWNER = 'macoder68';
const REPO_NAME = 'MACODER-XMD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *MACODER-XMD PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        const statusMessage = {
            image: { url: `https://files.catbox.moe/73mlk5.jpg` }, // Replace with your image URL
