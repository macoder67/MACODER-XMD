...
cmd({
  ...
  try {
    ...
    await reply('> *MACODER-XMD is Processing...*');
...
*/
 // Send the status message with an image
        await conn.sendMessage(from, { 
            image: { url: `https://https://files.catbox.moe/73mlk5.jpg` },  // Image URL
            caption: caption,
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: '『 𝐌𝐀𝐂𝐎𝐃𝐄𝐑 𝐗𝐌𝐃 𝐒𝐇𝐎𝐑𝐓 𝐔𝐑𝐋 』',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
